...
import { HOME, LOGIN, REGISTER, CONFIRMEMAIL, TIMETABLE, FORGOTPASSWORD, SETNEWPASSWORD, STUDENTNUMBER } from '../util/routes';
      ...
      <BrowserRouter>
        <div className="container">
          <Switch>
            ...
            <Route path={STUDENTNUMBER} component={onlyAuth(StudentNumber)} />
