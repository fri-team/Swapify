...
class EditBlockForm extends Component {
  ...
  handleSubmit = () => this.props.onSubmitClick();

  handleClickOutside = () => {
    this.props.onCloseEditBlock();
  }
  fetchCourses = () => {
    ...
    return (
      <form>
        ...
        <div className="buttons">
          ...
          <DialogTitle>Upravenie bloku</DialogTitle>
          <DialogContent>
            <FlexBox>
            <Autocomplete
                defaultValue={courseName + " (" + courseShortcut + ")"}
