...
Scenario('[EDIT01] Verify, that modified length of subject will be correctly display on board', async(I) => {
    ...
    I.click(locate('.block')
        .withAttr({style: 'grid-area: 3 / 4 / 5 / 6; ' +
                            'margin-top: 0%; ' +
    ...
    I.seeElement(locate('.block')
        .withAttr({style: 'grid-area: 3 / 4 / 5 / 5; ' +
                            'margin-top: 0%; ' +
                            'background-color: rgb(255, 87, 34); ' +
                            'color: rgb(255, 255, 255); ' +
                            'z-index: 2;'})
...
Scenario('[EDIT02] Verify, if edited subject is saved (with informations) on board correctly', async(I) => {
    ...
    let styleAndPositionOfEditedBlock = 'grid-area: 5 / 1 / 7 / 2; '+
                                        'margin-top: 0%; ' +
                                        'background-color: rgb(0, 188, 212); ' +
                                        'color: rgba(0, 0, 0, 0.87); z-index: 2;';
    I.seeElement(locate('.block')
...
Scenario('[EDIT03] Verify, if lecture will be changed to laboratory', async(I) => {
    ...
    I.assertEqual(iconsOfBlocks[1],'M437.2 403.5L320 215V64h8c13.3 0 24-10.7 ' +
                                    '24-24V24c0-13.3-10.7-24-24-24H120c-13.3 0-24 ' +
                                    '10.7-24 24v16c0 13.3 10.7 24 24 24h8v151L10.8 ' +
                                    '403.5C-18.5 450.6 15.3 512 70.9 512h306.2c55.7 ' +
                                    '0 89.4-61.5 60.1-108.5zM137.9 320l48.2-77.6c3.7-5.2 ' +
                                    '5.8-11.6 5.8-18.4V64h64v160c0 6.9 2.2 13.2 5.8 18.4l48.2 77.6h-172z');
