...
namespace BackendTest
{
    public class EmailServiceTests
    {
        ...
        {
            var path = "../../../../../Backend/EmailTemplate/RegistrationTemplate.html";
            string body;
            ...
            var url = new UrlSettings() { ApplicationUrl = "http://localhost:5000/api/" };
